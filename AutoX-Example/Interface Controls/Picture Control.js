...
ui.layout(
	<scroll>
		<vertical bg="#707070" padding="16">
			...
			<text text="Picture with border" textColor="black" textSize="16sp" marginTop="16" />
			<img src="http://www.autojs.org/assets/uploads/profile/1-profileavatar.jpeg"
				w="100" h="100" borderWidth="2dp" borderColor="#202020" />

			<text text="Circular picture" textColor="black" textSize="16sp" marginTop="16" />
			<img src="http://www.autojs.org/assets/uploads/profile/1-profileavatar.jpeg"
				w="100" h="100" circle="true" />

			<text text="Circular image with border" textColor="black" textSize="16sp" marginTop="16" />
			<img src="http://www.autojs.org/assets/uploads/profile/1-profileavatar.jpeg"
